import sys
# Read file
with open(r'D:\AI_MIYA_Facyory\MIYA\Miya\core\web_api\__init__.py', 'r', encoding='utf-8') as f:
    content = f.read()

# Check if already has kb routes
if '/api/kb/list' in content:
    print("Already has KB routes")
    sys.exit(0)

# Find insertion point - after capabilities endpoint
