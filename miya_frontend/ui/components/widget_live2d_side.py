...
from PyQt5.QtCore import Qt, QTimer, pyqtSignal, QPropertyAnimation, QRect  # 统一入口 #
from PyQt5.QtGui import QPixmap, QPainter, QColor, QBrush, QPen, QIcon  # 统一入口 #
from PyQt5.QtCore import QSize  # 统一入口 #
