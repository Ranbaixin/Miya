...
from PyQt5.QtWidgets import QFrame, QVBoxLayout, QLabel, QWidget, QSizePolicy, QPushButton, QHBoxLayout  # 统一入口 #
from PyQt5.QtCore import Qt, QPropertyAnimation, QEasingCurve, QTimer  # 统一入口 #
from PyQt5.QtGui import QFont  # 统一入口 #
...
class MessageDialog(QFrame):
    ...
    def setup_ui(self):
        ...
        self.content_label.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)  # 设置大小策略
        self.content_label.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)  # 左对齐
