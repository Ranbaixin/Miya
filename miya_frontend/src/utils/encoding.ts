...
export interface StreamChunk {
  type: 'content' | 'reasoning' | 'content_clean' | 'round_start' | 'tool_calls' | 'tool_results' | 'round_end' | 'auth_expired' | 'token_refreshed' | 'compress_start' | 'compress_progress' | 'compress_end' | 'compress_info' | 'status' | 'intent_result' | 'pre_search_start' | 'pre_search_end' | 'done'
  text?: string
  round?: number
