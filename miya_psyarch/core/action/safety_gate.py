...
from miya_psyarch.core.action.registry import is_external_action
    ...
    def review(
        ...
        *,
        ...
        for row in list(selected_actions or []):
            ...
            risk = _clamp(max(predicted_pressure, cor * 0.95, punishment), 0.0, 1.0)
            reasons = []
            ...
            if cor >= self.veto_cor_threshold:
