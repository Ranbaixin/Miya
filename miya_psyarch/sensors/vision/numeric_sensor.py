...
from miya_psyarch.sensors.reconstruction_payload import make_reconstruction_payload, payload_summary_vector
...
class NativeVisionNumericSensor:
    ...
    def _object_regions(
        ...
        *,
        ...
        for x, y, w, h, score in boxes:
            ...
            object_anchor_id = self._spatial_object_anchor_id(spatial[:4])
            selected.append(
                {
    ...
    def _spatial_object_anchor_id(self, bbox_norm: list[float]) -> str:
        """
